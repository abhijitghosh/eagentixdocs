...
| :--- | :--- | :--- |
| **01** | **[Site Brief](/studios/seo-studio/01-site-brief)** | Establish ground truth: market, business offerings, audience, competitors, and voice. |
| **02** | **[Keywords & SERP](/studios/seo-studio/02-keyword-campaigns)** | Real volume, intent, difficulty, and automated SERP rank tracking campaigns. |
| **03** | **[Write](/studios/seo-studio/04-content-drafting)** | Generate search-ready content strictly locked to verified research and brand proof. |
| **04** | **[On-page](/studios/seo-studio/05-onpage-intelligence)** | Audit individual URLs against checklist scorecards and benchmark against top competitors. |
| **05** | **[Links](/studios/seo-studio/06-links-and-architecture)** | Inspect internal link equity distribution, discover orphan pages, and analyze backlink gaps. |
| **06** | **[Visibility](/studios/seo-studio/00-overview#visibility)** | Monitor AI engine visibility (ChatGPT Search, Perplexity, Google AI Overviews) and citations. |
